...
MemHub 是一个无服务端、Git-first 的个人 AI 记忆协议。本 Skill 让 Hermes/OpenClaw 类 Agent 能够读写、归档和同步用户的跨 Agent 统一记忆仓库。
...
将本目录 `skills/hermes-memhub/` 复制到对应 skills 目录，或通过 SkillHub/ClawHub 安装。
