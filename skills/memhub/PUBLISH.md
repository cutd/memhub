...
curl -X POST https://clawhub.ai/api/v1/skills \
  ...
  -F 'payload={"slug":"memhub","displayName":"MemHub","version":"0.1.4","changelog":"将 Skill 名称泛化为 MemHub；完善 Agent 同步行为协议；支持 GitHub/Gitee OAuth、token/SSH fallback。","tags":["memory","memhub","github","gitee","sync","agent-memory"]}' \
